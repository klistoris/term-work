...
<main>
    ...
    <div class="form_registrace">
        ...
        <form method="post" >
            ...
            <label>Email:</label>
            <input name="email" type="email" required value='<?=$email ?>' placeholder=<?php echo $email?>/>
            <label>Věk:</label>
            <input name="vek" type="number" min="1" required value='<?=$vek ?>' placeholder=<?php echo $vek?>/>
            <label>Telefon:</label>
            <input name="telefon" type="number" min="0" required value='<?=$telefon ?>' placeholder=<?php echo $telefon?>/>
            <label>Heslo:</label>
