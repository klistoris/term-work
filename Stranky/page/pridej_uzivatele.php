...
<main>
    ...
    <div class="form_registrace">
        ...
        <form method="post" >
            ...
            <label>Email:</label>
            <input name="email" type="email" placeholder="Vložte email" required/>
            <label>Věk:</label>
            <input name="vek" type="number" placeholder="Vložte věk" min="1" required/>
            <label>Telefon:</label>
            <input name="telefon" type="number" min="0" placeholder="Vložte telefon" required/>
            <label>Heslo:</label>
